...
router.get("/admin/get-employee-details", employeeController.getEmployeeDetails);
...
router.post("/admin/employee-registration", employeeController.registerEmployee);
...
router.get("/get-reporting-managers", employeeController.getReportingManagersList);
router.post("/get-reporting-managers", employeeController.getReportingManagersList);
...
router.post("/admin/add-employee-documents", uploadAdmin.any(), employeeController.uploadEmployeeDocuments);
router.get("/get-attendance", attendanceController.getAttendance);
router.post("/admin/get-detail-edit-employee", employeeController.getEditEmployeeDetails);
...
router.post("/admin/absconding-send-check", letterController.checkAbscondingStatus);
router.post("/admin/update-emp-document", uploadSingle.single('image'), employeeController.updateDocument);
